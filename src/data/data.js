    ...
    settings: [
      {
        ...
        values: [
          { label: "usd", value: "usd", type: "select" },
          { label: "eur", value: "eur", type: "select" },
          { label: "jpy", value: "jpy", type: "select" },
          { label: "gbp", value: "gbp", type: "select" },
          { label: "chf", value: "chf", type: "select" },
          { label: "cad", value: "cad", type: "select" },
        ],
      },
      {
        ...
        defaultValue: "accountingMethodology",
        id: "_accountingDropDown",
        values: [
          { label: "fifo", value: "fifo", type: "select" },
          { label: "lifo", value: "lifo", type: "select" },
        ],
      },
    ],
  },
